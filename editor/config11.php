...
//Site info *************************
define('HOST_URL','http://webglstudio/');
define('MAIL_ADDRESS','silorak12336@gmail.com');

// SQL database *********************
define('DB_NAME', 'webglstudio'); //your database name
define('DB_USER', 'silorak'); //your database user
define('DB_PASSWORD', 'silorak852'); //your database password
...
//System ****************************
define('ADMIN_PASS','adminas'); //CHANGE THIS
define('ADMIN_MAIL','silorak12336@gmail.com'); //CHANGE THIS
define('GLOBAL_PASS_SALT','pepper salt and other herbss'); //ENTER SOMETHING RANDOM HERE
define('UNITNAME_SALT','sausages bacon and spams'); //ENTER SOMETHING RANDOM HERE
